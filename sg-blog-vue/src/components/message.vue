            ...
            <div class="tmsg-commentshow">
                <ul class="tmsg-commentlist">
                    ...
                    <li class="tmsg-c-item" v-for="(item,index) in commentList" :key="'common'+index">
                        <article class="">
                            <header>
                                <img  :src="`${$store.state.baseURL}download?name=${item.avatar}`" :alt="$store.state.errorImg" :onerror="$store.state.errorImg">
                                <div class="i-name">
                                    {{item.username}}
                                </div>
                                <!-- <div class="i-class">
                        ...
                        <ul v-show="item.children" class="tmsg-commentlist" style="padding-left:60px;">
                            <li class="tmsg-c-item" v-for="(citem,cindex) in item.children" :key="'citem'+cindex">
                                <article class="">
                                    <header>
                                            <img :src="`${$store.state.baseURL}download?name=${citem.avatar}`"  :alt="$store.state.errorImg" :onerror="$store.state.errorImg">
                                            <div class="i-name">
