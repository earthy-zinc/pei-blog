                    ...
                    <ul class="userInfoBox">
                        <li class="avatarlist">
                            ...
                            <el-upload
                              ...
                              <img   v-if="imgUrl" :src="imgUrl ? imgUrl :'static/img/tou.jpg'"
                                     :alt="$store.state.errorImg"
                    ...
                    <ul class="userInfoBox">
                        <li class="avatarlist">
                            ...
                            <div class="avatar-uploader">
                                <img  :src="imgUrl?imgUrl:'static/img/tou.jpg'"  :alt="$store.state.errorImg" :onerror="$store.state.errorImg" class="avatar">
                            </div>
                        </li>
                        <li class="username">
                            <span class="leftTitle">昵称</span>
        ...
        methods: { //事件处理器
            handleAvatarSuccess(res, file) {//上传头像
                if(res.code == 200){
                    ...
                    this.imgUrl = `${store.state.baseURL}download?name=${res.data}`;
            ...
            routeChange: function(){//展示页面信息
                ...
                if(localStorage.getItem('userInfo')){
                    ...
                    getUserInfo(that.userId).then((response)=>{
                        ...
                        that.imgUrl = store.state.baseURL + "download?name="+that.userInfoObj.avatar
                    })
                }else{
                    that.haslogin = false;
                }
